...
3. 正确填写你的： **校园网账号、密码以及对应的认证网卡（如 eth0）**。
4. 点击 **"保存并应用"** 即可开始认证。
...
如果你在安装或使用过程中遇到了问题，欢迎在 **[Issues 页面](../../issues)** 和QQ群 **762579697** 提交反馈。如果你觉得这个项目帮到了你，别忘了点击右上角点一个 **⭐ Star** 支持一下哦！
